...
#pragma region Player2
  ...
  player2.currentHealth[0]->m_screenSpaceTransform.position.x +=  100;
  ...
  player2.currentHealth[1]->m_screenSpaceTransform.position.x +=   80;
  ...
  player2.slash->m_screenSpaceTransform.position.x +=  68;
  ...
  player2.maxHealth[0]->m_screenSpaceTransform.position.x +=  52;
  ...
  player2.maxHealth[1]->m_screenSpaceTransform.position.x +=  39;
